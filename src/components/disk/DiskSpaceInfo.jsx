...
const DiskSpaceInfo = () => {
    ...
    return (
        <div style={{ position: 'fixed', bottom: '20px', left: '20px', backgroundColor: 'white', padding: '10px', border: '1px solid #ccc', borderRadius: '6px', boxShadow: '0 0 10px rgba(0, 0, 0, 0.1)' }}>
